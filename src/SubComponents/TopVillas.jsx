...
const TopVillas = () => {
  return (
    <section id="topVillas">
      ...
      <p>
        Explore our exclusive selection of top-rated villas, perfect for your next getaway. Whether you're seeking comfort, style, or breathtaking views, these villas offer an unforgettable experience.
      </p>
